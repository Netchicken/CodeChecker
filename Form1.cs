    ...
    public partial class Form1 : Form
    {
        ...
        private void GetAllFiles()
        {
            ...
            try
            {
                ...
                {
                    //filter the folders
                    if (!f.Contains("Debug") && !f.Contains(".vs") && !f.Contains("packages") && !f.Contains("obj") && !f.Contains("Properties") && !f.Contains("Resources") && !f.Contains("Program.cs") && !f.Contains(".zip"))
                    {
                ...
                foreach (var text in AllFiles)
                {
                    ...
                    {
                        // double levPath = (Lev.Distance(text.Key, text2.Key));

                        //only compare files where the path is not exactly the same
                        ...
                        //  if (text.Key != text2.Key && levPath > 40)

                        if (ShortText1 != ShortText2)
                        {
                ...
                //output to screen
                lbxOutput.Items.Add("Matches will Appear TWICE");
